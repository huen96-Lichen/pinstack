...
on run argv
    ...
    -- 临时文件路径
    set tempImage to (POSIX path of (path to temporary items)) & "screenshot.png"
    ...
    -- 使用sips命令获取指定位置的颜色
    set colorOutput to do shell script "sips -g pixelColor -X " & x & " -Y " & y & " " & quoted form of tempImage
