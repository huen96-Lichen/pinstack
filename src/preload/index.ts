...
const api = {
  ...
  wiki: {
    getStatus: (): Promise<WikiStatus> => invoke<WikiStatus>('wiki.getStatus'),
    query: (input: WikiQueryInput): Promise<WikiQueryResult> => invoke<WikiQueryResult>('wiki.query', input),
    lint: (): Promise<WikiLintResult> => invoke<WikiLintResult>('wiki.lint'),
    openDir: (): Promise<boolean> => invoke<boolean>('wiki.openDir'),
    openIndex: (): Promise<boolean> => invoke<boolean>('wiki.openIndex'),
  },
  debug: {
